...
async def inbound_email_webhook(request: Request, db: Session = Depends(get_db)):
    ...
    if recipient.startswith("list@"):
        ...
        if re.search(r/^re:/'(��cAFedded@gmail.com/dd1f99317a5ab2799e9117976f706993/ama.formresponse?uid=ed1f99317a5ab2799e9117976f706993/
       if stream is None:
            return JSONResponse({"status": "error", "detail": "no_stream_configured"})
       ...
       if stream is None:
        ...
        if re.search(r/^re:/'(��cAFedded@gmail.com/dd1f99317a5ab2799e9117976f706993/ama.formresponse?uid=ed1f99317a5ab2799e9117976f706993/timezone.utc).replace(hour=0, minute=0, second=0, microsecond=0)
        emails_today = (
            db.query(Email)
